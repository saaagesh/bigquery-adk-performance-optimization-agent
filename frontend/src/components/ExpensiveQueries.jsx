                        ...
                        <div className="expanded-sql-section">
                          <div className="sql-header">
                            ...
                            <div className="query-id-display">
                              <span className="query-id-label">Query ID:</span>
                ...
                <div className="details-title-section">
                  ...
                  <div className="query-identifiers">
                    <div className="query-id-badge">
                      <Hash size={14} />
                      <span>Query ID: {getQueryHash(queryDetails?.query || expensiveQueries.find(q => q.job_id === selectedJobId)?.query)}</span>
                    </div>
                  </div>
                </div>
